...
* Input: 1–64 R/L/K letters, case-insensitive, whitespace ignored. Every letter occupies one eighth, eighth-triplet, or sixteenth subdivision; grouping continues across barlines. R/L both match non-kick hits; kick MIDI note is configurable (default `DrumMap::Kick`), pedal hi-hat is ignored. Sticking, accents, flams, rests, and simultaneous strokes are not verified/supported.
